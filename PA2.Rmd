...
eco.impacts.Total10$EVTYPE.ECO<-factor(eco.impacts.Total10$EVTYPE,
                                      levels=eco.impacts.Total10$EVTYPE)

ggplot(data=eco.impacts.Total10,aes(x=EVTYPE.ECO,y=TOTAL,fill=EVTYPE)) +
        geom_bar(stat="identity") +
...
The Crop Damage scale is `r crop.scale` of the Property Damge.
...
ggplot(data=tornado.ph,aes(x=EV_TORNADO,y=IMPACT,fill=EV_TORNADO)) +
        geom_bar(stat="identity") +
        ggtitle("Population Health Impacts by Tornado and Others") +
        theme(axis.text.x = element_text(angle = 90, hjust = 1))


ggplot(data=tornado.ec,aes(x=EV_TORNADO,y=IMPACT,fill=EV_TORNADO)) +
        geom_bar(stat="identity") +
...
Tornado has population health impacts `r tornade.ph.per`% of total events. It is totally high.
Tornado has ecnomic impacts `r tornade.ec.per`% of total events. Especially property damage is high.
